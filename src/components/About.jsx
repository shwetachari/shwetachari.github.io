  ...
  render() {
    return (
      <div className="main-section col-xs-12">
        ...
        <div className="paragraph text-center col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
        ...
        <div className="paragraph col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
          <span className="toolbeltText">My toolbelt</span> includes experience in back-end development, which enables me to draw important connections concerning optimization, persistence, and latency between a client-facing application and server-side logic. I am proficient in managing SQL and NoSQL databases with supplemented flexibility in data handling from ORMs. I am able to build, maintain, and scale REST API servers, taking advantage of the asynchronous nature of Node.js to maximize efficiency through process decoupling and ensuring modularity using the Express and Express Router modules.
        </div>
        <div className="paragraph col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
          <span className="toolbeltText">My toolbelt</span> includes experience in front-end development, which allows me to receive and translate user interaction with an application into meaningful events that persist through the the back-end. I maintain a separation of concerns in terms of functionality using MVC/MV* frameworks like AngularJS and React, with additional power in DOM manipulation from integration with jQuery, jQuery-UI, and D3.js.
        </div>
        <div className="paragraph col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
